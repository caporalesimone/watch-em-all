...
>
> English mirror of [`docs/infrastructure/dev-container.md`](../../docs/infrastructure/dev-container.md), limited to what is implemented (DOC-12). The dev container is delivered in phase 0.
