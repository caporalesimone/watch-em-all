...
| [`../docs/`](../docs/README.md) | **Documentazione inglese** (la wiki canonica designata): traduzione di questa `docs-ita/` per la sola parte implementata, cresce alla chiusura di ogni fase (DOC-12); a v1 sostituirà `docs-ita/` | Developer, utenti internazionali |
