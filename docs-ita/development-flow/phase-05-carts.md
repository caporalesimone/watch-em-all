...
- [x] **5.F3 — Soglia con conversione + barra** (~1h): input soglia **in €**, con la **% come comodità di input** nella UI (mostra l'equivalenza "20% ≈ €X" sul totale pieno corrente e invia il valore in €), barra di avvicinamento. *Verifica: barra coerente con lo stato calcolato.*
