...
- **Feature flags + admin pages.** A self-building **Feature flags** page (dev knobs: worker tick, scrape-now cooldown — non-persistent) and a **Plugins** page (type + version).
